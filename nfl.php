        ...
        <div class="container"> 
          <div id="video"> 
            <div id="video-player" class="embed-responsive embed-responsive-16by9 video pointer nocontext"> 
              <video style="object-fit: cover;" id="videoPlayer" class="embed-responsive-item" preload="none" poster="/img/nfl.jpg"> 
              ...
              <div class="entry-content"> 
                ...
                <div class="row"> 
                  <div class="col-md-3 text-center hidden-xs hidden-sm"> 
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQGmDbHU-lVqKbOCpkWY_W6CuHoZjYyUg6Solxk-8AkNVghlWYlqQ" alt="<?php echo '' . htmlspecialchars($_GET["match"]) . ''; ?> Live Stream" width="185" height="278" class="img-responsive inblock main-poster"> 
                  ...
                  <br> 
                  <div class="col-md-9"> 
                    <p class="lead" itemprop="description" style="text-align: justify;">With <?php echo $_SERVER['HTTP_HOST']; ?> you can watch every NFL game live or on demand, on all of your devices, including your connected TV. Don't miss a single touchdown and enjoy our 24/7 live stream of NFL Games for award-winning content all season long. Fans can watch full NFL game replays in roughly 40 minutes with the Condensed Game feature, as well as multi-game viewing and access to archived games. Watch 20 pre-season and 256 regular season games of your favorite team live or on-demand. Watch on your favourite devices . Not at home? No problem. LIVE* Here with your smartphones, tablets, computers and available for iOS or Android. Dont miss it.
                    </p> 
                  </div> 
                </div> 
                <br> 
                <center>
                  <a href="#" onclick="window.location.href='<?php echo $site_url;?>/register.php'" data-ajax="false">
                    <img class="img-responsive" align="center" src="https://i.imgur.com/g5lb24c.png">
                  </a>
                </center> 
                <br> 
                <div class="row"> 
            ...
            <div class="modal-dialog"> 
              <div class="modal-content"> 
                ...
                <div class="modal-body"> 
                  <img class="img-responsive" src="/img/nfl.jpg" width="780" height="439" alt="<?php echo '' . htmlspecialchars($_GET["match"]) . ''; ?> Live Stream"> 
    ...
    <div class="container"> 
      <div class="row"> 
        ...
        <div class="site-credit col-md-12 text-center"> &copy;2019 
          <a href="<?php echo $site_url;?>/"><?php echo $site_url;?>
