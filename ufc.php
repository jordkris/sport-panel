        ...
        <div class="container"> 
          <div id="video"> 
            <div id="video-player" class="embed-responsive embed-responsive-16by9 video pointer nocontext"> 
              <video style="object-fit: cover;" id="videoPlayer" class="embed-responsive-item" preload="none" poster="/img/ufc.jpg"> 
              ...
              <div class="entry-content"> 
                ...
                <center>
                  <a href="#" onclick="window.location.href='<?php echo $site_url;?>/register.php'" data-ajax="false">
                    <img class="img-responsive" align="center" src="/img/ufc.png">
                  </a>
                </center> 
                <br> 
                <div class="row"> 
            ...
            <div class="modal-dialog"> 
              <div class="modal-content"> 
                ...
                <div class="modal-body"> 
                  <img class="img-responsive" src="/img/ufc.jpg" width="780" height="439" alt="<?php echo '' . htmlspecialchars($_GET["match"]) . ''; ?> Live Stream"> 
