        ...
        <div class="container"> 
          <div id="video"> 
            <div id="video-player" class="embed-responsive embed-responsive-16by9 video pointer nocontext"> 
              <video style="object-fit: cover;" id="videoPlayer" class="embed-responsive-item" preload="none" poster="/img/soccer.jpg"> 
              ...
              <div class="entry-content"> 
                ...
                <div class="row"> 
                  <div class="col-md-3 text-center hidden-xs hidden-sm"> 
                    <img src="/img/soccer2.png" alt="<?php echo '' . htmlspecialchars($_GET["match"]) . ''; ?> Live Stream" width="185" height="278" class="img-responsive inblock main-poster"> 
