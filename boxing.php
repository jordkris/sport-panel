        ...
        <div class="container"> 
          <div id="video"> 
            <div id="video-player" class="embed-responsive embed-responsive-16by9 video pointer nocontext"> 
              <video style="object-fit: cover;" id="videoPlayer" class="embed-responsive-item" preload="none" poster="/img/boxing.jpg"> 
              ...
              <div class="entry-content"> 
                ...
                <div class="row"> 
                  <div class="col-md-3 text-center hidden-xs hidden-sm"> 
                    <img src="/img/on.jpg" alt="<?php echo '' . htmlspecialchars($_GET["match"]) . ''; ?> Live Stream" width="185" height="278" class="img-responsive inblock main-poster"> 
                  ...
                  <br> 
                  <div class="col-md-9"> 
                    <p class="lead" itemprop="description" style="text-align: justify;">Watch Live BOXING full fight live broadcast with HD Video| live boxing from the UK, Europe, the US and across the world. We're on air 24/7 bringing you boxing every night of the week. BOXING live stream, Live Broadcast - BOXING live stream | streaming BOXING. To watch BOXING online in best quality as well performance we advice you to use google chrome/Safari as browser. You should as well disable Adblock or any adblocker, those are blocking needed resources to start most of the streams. BOXING online broadcast. We advice you to refresh page to check if new feeds are added for any questions use the chat box or contact us via Facebook. BOXING online video and links from international TV Channels - we do our best to provide you with multiples language feeds. Live Score and Results. Where can I watch BOXING online - Here free and legit !
                    </p> 
                  </div> 
                </div> 
                <br> 
            ...
            <div class="modal-dialog"> 
              <div class="modal-content"> 
                ...
                <div class="modal-body"> 
                  <img class="img-responsive" src="/img/boxing2.jpg" width="780" height="439" alt="<?php echo '' . htmlspecialchars($_GET["match"]) . ''; ?> Live Stream"> 
